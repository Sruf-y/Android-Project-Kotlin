...
//        }
    ...
    override fun onApplyWindowInsets(
        ...
        //if(types==persistentInsetTypes){
            val typeInsets = windowInsets.getInsets(types)
            v.setPadding(typeInsets.left, typeInsets.top, typeInsets.right, typeInsets.bottom)
//        }else{
//            val systembars = windowInsets.getInsets(types or WindowInsetsCompat.Type.displayCutout())
//            val ime=windowInsets.getInsets(WindowInsetsCompat.Type.ime())
//            v.setPadding(systembars.left, systembars.top, systembars.right, systembars.bottom+ime.top)
//        }
